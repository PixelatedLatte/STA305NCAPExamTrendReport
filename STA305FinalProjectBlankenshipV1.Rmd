...
# Replace 3rd colum with correct name, filter out non schools, filter out *'s in dataset, convert tables to be named with clearer names, delete dupes, select only needed columns.
